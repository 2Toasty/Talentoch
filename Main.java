...
// que significa public 
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("5. Consultar artículo por ID");
    ...
    public static boolean validarNombre(String nombre) {
        if (nombre.isEmpty()) {
            ...
            return true; // El nombre es inválido
        }
        return false; // El nombre es válido
    }

    public static boolean validarPrecio(double precio) {
        if (precio <= 0) {
            System.out.println("El precio debe ser mayor a 0.");
            return true; // El precio es inválido
        }
        return false; // El precio es válido
    }
    ...
    public static void consultarArticuloPorId() {
